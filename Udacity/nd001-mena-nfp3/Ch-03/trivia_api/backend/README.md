...
Developers using this project should already have Python3, pip, node, and npm/yarn installed.
...

       {
          ...
          "questions": [
            ...
            },
            {
              ...
              "difficulty": 2,
              "id": 3,
              "question": "what's your wife name? "
            },
            {
              "answer": "Answer 3",
              "category": 2,
...
* Sample: `curl http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{
            "question": "Name of Biggest Country in the world?",
            "answer": "Russia",
            "difficulty": 3,
            "category": "2"
        }'`<br>
        ...
        {
            "created": 173, 
            "question_created": "Name of Biggest Country in the world?", 
            "questions": [
                {
                    "answer": "Apollo 13", 
                    "category": 5, 
...
## Deployment
  will deployed it soon
## Authors

Mohammed Elzanaty authored the API (`__init__.py`), 
test suite (`test_flaskr.py`), and this README.<br>
All other project files, including the models and frontend, were created by [Udacity](https://www.udacity.com/) as a project template for the task

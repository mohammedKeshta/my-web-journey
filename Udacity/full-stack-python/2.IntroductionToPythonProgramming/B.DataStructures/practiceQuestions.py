...
####################################################
"""
    TODO: find the number of unique words in the text.
...
"""
    ...
    4. Hint: Use the appropriate dictionary method to get a list of its keys, and then sort that list. Use this list of keys to answer the next two questions as well.
    5. Which key (word) has the highest value in verse_dict?
"""
...
contains_breathe = verse_dict.get('breathe') # OR 'breathe' in verse_dict
